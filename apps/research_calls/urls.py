...
urlpatterns = [
    path('', views.live_calls_view, name='list'),
    # Backward-compatible aliases used by existing templates/views
    path('', views.live_calls_view, name='call_list'),
    ...
    path('<int:pk>/', views.call_detail_view, name='call_detail'),
    path('create/', views.call_create_view, name='create'),
    path('create/', views.call_create_view, name='call_create'),
